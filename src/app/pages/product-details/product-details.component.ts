...
export class ProductDetailsComponent implements OnInit, OnDestroy {
  ...
  private updateMetaData() {
    ...
    this.meta.updateTag({ name: 'copyright', content: 'tee' });
    this.meta.updateTag({ name: 'author', content: 'tee' });
    ...
    this.meta.updateTag({ property: 'og:url', content: `https://practiceenglishschool.softlabit.com${this.router.url}` }); this.meta.updateTag({ property: 'og:image', content: this.product?.images[0] ? this.product?.images[0] : this.product?.images[0] });
    ...
    this.meta.updateTag({ property: 'og:site_name', content: 'tee' });
    ...
    this.meta.updateTag({ name: 'twitter:site', content: '@tee' });
    this.meta.updateTag({ name: 'twitter:creator', content: '@tee' });
