 ...
 */
  ...
  get grandTotal(): number {
    return (this.cartSubTotal + (this.formData.value.deliveryOptions === '1' ? this.shippingCharge?.deliveryInDhaka : this.formData.value.deliveryOptions === '2' ? this.shippingCharge?.deliveryOutsideDhaka : 0)) - this.couponDiscount -this.cartDiscountAmount;
  }
